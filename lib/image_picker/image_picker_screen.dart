      ...
      body: Center(
        ...
        child: Column(
          ...
          children: [
            ...
            Lottie.asset('assets/capture2_anim.json'),
            Lottie.network(
              'https://lottie.host/embed/5609ea9c-b93b-4db4-bfc0-57b4333a3d76/Fr2qWd56gk.lottie',
            ),
            ...
            ElevatedButton(
                onPressed: () async {
                  try {
                    final XFile? pickedFile = await _picker.pickImage(
                      source: ImageSource.gallery, // camera gallery
                      // maxWidth: maxWidth,
                      // maxHeight: maxHeight,
                      imageQuality: 100,
                    );
